...
public class HomePage2 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter adapter = new SimpleAdapter(this, getData(), R.layout.p_event, new String[]{"text1","text2","text3","text4","text5"}, new int[]{R.id.event1,R.id.event2,R.id.event3,R.id.event4,R.id.event5});
		listView.setAdapter(adapter);
		listView.setOnItemClickListener(listener2);
		//button.setOnClickListener(this);
		btn2=(ImageButton)findViewById(R.id.createvent);
        btn2.setOnClickListener(listener);
        btn1=(ImageButton)findViewById(R.id.confirmevents);
	...
	private OnClickListener listener =new OnClickListener()
	 {
	  ...
	  public void onClick(View v)
	  {
	   ...
	   switch (btn.getId())
	   {
	    case R.id.confirmevents:
	    	Intent intent = new Intent(HomePage2.this, HomePage.class);  
			startActivity(intent); 
	     break;
	    case R.id.createvent:
	    	Intent intent2 = new Intent(HomePage2.this, CreatEvent.class);  
	...
	//public void onClick(View v){
	//	Intent intent = new Intent(HomePage2.this, CreatEvent.class);  
	//	startActivity(intent); 
